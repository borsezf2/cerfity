...
Widget MasterOwnAll(context,email)
{
...
//            color: Colors.black12,
              child:
              StreamBuilder(
                  stream: mainModel.MasterOwnMasterListStart(email).asStream(),
                  builder: (context, snapshot) {
                    return mainModel.MasterOwnCoursesList.length == 0 ?
                    LinearProgressIndicator()
                        : ListView.builder(

                        padding: EdgeInsets.all(10),
                        itemCount: mainModel.MasterOwnCoursesList.length,
                        itemBuilder: (context, index) {
//                          print("X 11");
                          CourseModel data = mainModel.MasterOwnCoursesList[index];
//                          print("X 12");
//                              var data = snap.data;
//                          print("X 13");
                          return Column(
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            Align(
              ...
              child: DetailsOfInstituteForMaster(context,widget.data),
            ),
          ],
        ),
      ),
