          ...
          child: Stack(
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: Text("Sign In",style: TextStyle(color: Colors.red,fontSize: 25,fontWeight: FontWeight.bold),),
              ),
//              Align(
...
Widget SignInButton(context){
  return ScopedModelDescendant<mainModel>(
    ...
    onPressed: ()async{
      var user = await mainModel.signInWithEmail(email: emailController.text,password: passwordController.text);
...
//          Navigator.pushReplacement(
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>DashBoardPage(user.email.toString())));
      }
      else {
